...
$Global:self = @{
    ...
    Schedule = '1d'
    Impact = 6
    LikelihoodOfCompromise = '<p>If TRUST_ATTRIBUTE_TREAT_AS_EXTERNAL is set to true, the security of a cross-forest trust is relaxed and trusts are treated as equivalent to external trusts.</p><br /><p>An attacker that compromises the remote Active Directory forest, with this set to true, can spoof most users and computers in the local Active Directory forest. This would allow the attacker to act as local users or computers and access resources they have privileges in. An attacker can also use this for privilege elevation and compromise the local forest.</p><h3>References</h3><p><a href="https://www.semperis.com/blog/active-directory-security/active-directory-security-best-practices-checklist/" target="_blank">Active Directory Security Best Practices | Semperis</a></p>'
    ResultMessage = 'Found {0} outbound trusts where SIDHistory is enabled.'
    Remediation = '<p>Unless a forest migration is currently in process, SID filtering should be enabled on the trust.</p><br /><p>Organizations should understand the risk of leaving this enabled for an extended period of time.</p><br /><p>The following command can be run to enable:</p><br /><p>NETDOM TRUST <ForestName> /domain:<TrustedForest> /EnableSIDHistory no</p><h3>References</h3><p><a href="https://www.semperis.com/blog/active-directory-security/active-directory-security-best-practices-checklist/" target="_blank">Active Directory Security Best Practices | Semperis</a></p>'
    Types = @('IoE')
    DataSources = @('AD.LDAP')
    OutputFields = @(
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA7Cr+HWzIFLNBr
# xlB52mdtYD0n3Qa7WkBqg6/Nb3tME6CCE3wwggVyMIIDWqADAgECAhB2U/6sdUZI
...
# FTAvBgkqhkiG9w0BCQQxIgQgLzJt35cdqE/0pJ/zWQ//fIeJ+WV74Vh9pB0Iy3gg
# WqowDQYJKoZIhvcNAQEBBQAEggIAdfLCPOBI1lOjnuZ5T2gwHMT+oRIwh8c13thu
# +8MY6R9OYbv87Ab2ThWxTzWov2CqlHekQjXMk6O0eue2LQcJQM+Xwc4bVI/du0Lm
# p3LZ2JiW9kvZIC0D/v8xuwwwRG3afASWKQCXDs8DOomM6DdYYLkZDnRVDtiQLOzn
# A6bUmKALobkExeDoeLU/PH2dD/HBAKz6na24IhraZXRhJLkK14cKuuJ/pFCj5o/D
# DyfhZATFBho098XN4rEEKNwHopntuhouAapRIJy6OV5VK8PHKSSaO4RVGtI/yT2Y
# g6537/aN0u2O5cuLelnfk0SiGFuD3jrAiLzTHq5KEpJLXIauM0DGVQyf+yd7LTWk
# vgp3yV/BWYTzrmHJPibbSQ9P8sM/NzRtitPlUke0XygJ4rkn8/POuKXLSpaU0SM6
